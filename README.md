...
## 公開URL
- **本番環境（最新）**: https://2f38cecd.plarail-sns.pages.dev
...
### 💎 ポイント・投げ銭・交換所システム（NEW！）
1. **ポイントシステム**:
   - 初回ログイン時に**100ポイント**付与
   - 毎日のログインボーナスで**10ポイント**獲得
   - ナビゲーションバーで現在のポイント残高を確認
   - ポイント管理モーダルで取引履歴を確認

2. **投げ銭システム**:
   - 他のユーザーに10〜1000ポイントを送信可能
   - メッセージ付きで気持ちを伝えられる
   - 投稿カードの「投げ銭」ボタンから簡単に送信
   - 取引履歴で送受信の記録を確認

3. **交換所システム**（全19アイテム）:
   - **グッズ**: オリジナル巾着袋(80pt)、ステッカーセット(100pt)、トートバッグ(200pt)、キャップ(350pt)、Tシャツ(500pt)、パーカー(800pt)、マグカップ(120pt)、タンブラー(150pt)
   - **イベント参加券**: オンライン交流会(100pt)、オフ会参加券(200pt)、撮影会(300pt)、レイアウトコンテスト(200pt)、工場見学ツアー(800pt)
   - **特典**: ゴールドバッジ(150pt)、プラチナバッジ(300pt)、ダイヤモンドバッジ(500pt)、プレミアムアイコンフレーム(500pt)、カスタムプロフィール背景(400pt)、限定称号(300pt)
   - カテゴリ別フィルター機能
   - 在庫管理・交換履歴の確認

4. **ナビゲーション改善**:
   - どのページからでも**ロゴクリックでトップページ**に戻る
   - **質問ボタンクリックで質問セクション**へスクロール
   - スムーススクロール対応
   - 一貫性のある導線設計
